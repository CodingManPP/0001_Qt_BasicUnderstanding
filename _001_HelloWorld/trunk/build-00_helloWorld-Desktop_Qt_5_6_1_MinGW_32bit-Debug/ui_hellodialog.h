...
public:
    ...
    void setupUi(QDialog *HelloDialog)
    {
        ...
        HelloDialog->resize(162, 31);
        label = new QLabel(HelloDialog);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(20, 10, 126, 16));
    ...
    void retranslateUi(QDialog *HelloDialog)
    {
        ...
        label->setText(QApplication::translate("HelloDialog", "Hello World!\344\275\240\345\245\275\357\274\214Qt!", 0));
    } // retranslateUi
